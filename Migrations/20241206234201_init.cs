    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("1beda2ef-666b-48ac-99f7-3c9ecba2ab48"), new Guid("f880dc72-10d8-4863-bc07-cf023d2af10e"), new DateTime(2024, 12, 6, 23, 42, 1, 334, DateTimeKind.Utc).AddTicks(6255), "Jayrica", "Cunanan", "$2a$11$zl1iu5MLQTMJXNJUYWTy2OGPxQvQE/OluNOCsoGAckc5rtSllk2uS", "0422453888", new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "jricastudio@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0ebf03b0-2aea-47a3-b4c3-0b5abeb0cf16"), 2, new TimeOnly(7, 0, 0), new DateTime(2024, 12, 6, 23, 42, 1, 422, DateTimeKind.Utc).AddTicks(1555), 0, false, new TimeSpan(0, 10, 0, 0, 0), new TimeOnly(23, 0, 0), null },
                    { new Guid("3febe4b2-1607-44cf-a127-80959801687f"), 2, new TimeOnly(7, 0, 0), new DateTime(2024, 12, 6, 23, 42, 1, 422, DateTimeKind.Utc).AddTicks(1649), 3, false, new TimeSpan(0, 10, 0, 0, 0), new TimeOnly(23, 0, 0), null },
                    { new Guid("62f51407-a60e-48cd-9e06-47c4532769bc"), 2, new TimeOnly(7, 0, 0), new DateTime(2024, 12, 6, 23, 42, 1, 422, DateTimeKind.Utc).AddTicks(1690), 6, false, new TimeSpan(0, 10, 0, 0, 0), new TimeOnly(23, 0, 0), null },
                    { new Guid("6693ba1b-59b0-47c0-a84a-f911e2c77dc3"), 2, new TimeOnly(7, 0, 0), new DateTime(2024, 12, 6, 23, 42, 1, 422, DateTimeKind.Utc).AddTicks(1615), 1, false, new TimeSpan(0, 10, 0, 0, 0), new TimeOnly(23, 0, 0), null },
                    { new Guid("6bf31b08-c5be-47ee-94d2-19eecfff357d"), 2, new TimeOnly(7, 0, 0), new DateTime(2024, 12, 6, 23, 42, 1, 422, DateTimeKind.Utc).AddTicks(1661), 4, false, new TimeSpan(0, 10, 0, 0, 0), new TimeOnly(23, 0, 0), null },
                    { new Guid("768d0f79-ed4a-4cd1-b56e-9d472fc96ed5"), 2, new TimeOnly(7, 0, 0), new DateTime(2024, 12, 6, 23, 42, 1, 422, DateTimeKind.Utc).AddTicks(1627), 2, false, new TimeSpan(0, 10, 0, 0, 0), new TimeOnly(23, 0, 0), null },
                    { new Guid("e54a0867-9b29-41a3-bc0f-f5882107c90b"), 2, new TimeOnly(7, 0, 0), new DateTime(2024, 12, 6, 23, 42, 1, 422, DateTimeKind.Utc).AddTicks(1680), 5, false, new TimeSpan(0, 10, 0, 0, 0), new TimeOnly(23, 0, 0), null }
                });
